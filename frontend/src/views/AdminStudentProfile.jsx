...
export default function AdminStudentProfile() {
  ...
  if (!profileData) {
    return (
      <div style={{ padding: '40px', textAlign: 'center' }}>
        ...
        <button onClick={() => router.push('/admin/students')} style={{ padding: '12px 24px', backgroundColor: 'var(--color-sun-yellow)', border: '2px solid var(--color-ink)', borderRadius: '12px', fontWeight: 700, cursor: 'pointer', boxShadow: '4px 4px 0px var(--color-ink)' }}>
          Back to Students
        </button>
      </div>
    );
  ...
  return (
    <div style={{ padding: '40px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      {/* Multi-Session Academic History & Dynamic Timeline */}
      <div style={{ marginTop: '40px' }}>
        <StudentAcademicHistory studentId={id} />
      </div>
    </div>
  );
}
